                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="#"><i class="ti-user me-1 ms-1"></i>Log out</a>
                                <a class="dropdown-item" href="#"><i class="ti-wallet me-1 ms-1"></i></a>
                                <a class="dropdown-item" href="#"><i class="ti-email me-1 ms-1"></i></a>
                            </ul>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
